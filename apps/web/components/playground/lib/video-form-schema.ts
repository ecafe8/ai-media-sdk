import type { PlaygroundModel, VideoScenario } from "@/lib/playground/types";
...
function isMultiScenarioModel(model: PlaygroundModel): boolean {
 ...
 */
export function videoShowsDuration(model: PlaygroundModel): boolean {
 ...
 */
export function videoShowsAudioSetting(model: PlaygroundModel): boolean {
  return model.requiresInputVideo === true;
}
