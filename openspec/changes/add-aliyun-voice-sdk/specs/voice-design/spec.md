...
The SDK SHALL validate model-specific text lengths, supported language values, naming rules, sample rates, response formats, and required fields before network dispatch.
