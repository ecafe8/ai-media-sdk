/**
 * Volcengine Ark Doubao-Seedream Provider configuration boundary.
 *
...
/**
 * Seedream Provider configuration.
 */
 ...
 */
export function resolveBaseUrl(config: SeedreamConfig): string {
